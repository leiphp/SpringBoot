        ...
        <#--<div class="content">-->
            <#--<div class="container">-->
                <#--<div class="row">-->
                    ...
                    <#--<div class="row">-->
                        ...
                        <#--<div class="col-md-4">-->
                            <#--<div class="panel panel-default">-->
                                ...
                                <#--<div class="panel-body">-->
                                    <#--<ul class="list-group" >-->
                                        <#--&lt;#&ndash;<li class="list-group-item" each="log : ${logs}">&ndash;&gt;-->
                                            <#--&lt;#&ndash;<span text="${commons.fmtdate(log.created, 'yyyy-MM-dd HH:mm:ss')} +' => '+ ${log.action}"></span>&ndash;&gt;-->
                                        <#--&lt;#&ndash;</li>&ndash;&gt;-->
                                    <#--</ul>-->
                                <#--</div>-->
                            <#--</div>-->
                    ...
                    <#--</div>-->
                <#--</div>-->
                <#--&lt;#&ndash;<div replace="admin/footer :: footer-content"></div>&ndash;&gt;-->
